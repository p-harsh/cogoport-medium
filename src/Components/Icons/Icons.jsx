export const WriteSVG = ({ fill, className }) => (
    <svg
        fill={fill}
...
export const EditSVG = ({ fill, className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        height="48"
        viewBox="0 -960 960 960"
        ...
        className={className}
    >
        <path d="M480-120v-71l211-211 71 71-211 211h-71ZM120-330v-60h300v60H120Zm685-44-71-71 29-29q8-8 21-8t21 8l29 29q8 8 8 21t-8 21l-29 29ZM120-495v-60h470v60H120Zm0-165v-60h470v60H120Z" />
    </svg>
);

export const DeleteSVG = ({ fill, className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        height="48"
        viewBox="0 -960 960 960"
...
export const BookmarkSVG = ({ fill, className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        height="48"
        viewBox="0 -960 960 960"
...
export const SearchSVG = ({ fill, className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        height="48"
        viewBox="0 -960 960 960"
...
export const LogoutSVG = ({ fill, className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        height="48"
        viewBox="0 -960 960 960"
...
export const AccountSVG = ({ fill, className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        height="48"
        viewBox="0 -960 960 960"
